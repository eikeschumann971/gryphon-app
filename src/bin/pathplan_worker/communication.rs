...
impl WorkerCommunication {
    ...
    pub async fn register_with_planner(
        &self,
        capabilities: Vec<PlanningAlgorithm>,
    ) -> Result<(), String> {
    ...
    pub async fn signal_ready(&self) -> Result<(), String> {
        println!(
            "📡 Signaling worker {} is ready for assignments",
            self.worker_id
        );
    ...
    pub async fn accept_assignment(&self, plan_id: String) -> Result<(), String> {
        println!(
            "✅ Worker {} accepting assignment for plan {}",
    ...
    pub async fn report_completion(
        ...
        println!(
            "🎉 Worker {} reporting completion of plan {}",
            self.worker_id, plan_id
        );
    ...
    pub async fn report_failure(&self, plan_id: String, reason: String) -> Result<(), String> {
        println!(
            "❌ Worker {} reporting failure for plan {}: {}",
            self.worker_id, plan_id, reason
        );
    ...
    async fn simulate_assignment_reception(&mut self) -> Option<PlannerMessage> {
        ...
        println!(
            "   ⏳ Waiting {} seconds for potential assignment...",
            wait_time
        );
