...
use crate::domains::path_planning::aggregate::types::{Position2D, Orientation2D};
...
impl PathPlanClient {
    pub async fn new(logger: crate::domains::DynLogger) -> Result<Self, Box<dyn std::error::Error>> {
        ...
        Ok(Self { scenarios, event_store, planner_id, logger })
    }
}
