...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    let ds_arc: Arc<dyn gryphon_app::domains::path_planning::PathPlanningDataSource> =
        Arc::new(fs_ds);
    ...
    let path_planning_service =
        PathPlanningService::new(command_actor, ds_arc.clone(), pg_arc.clone());
